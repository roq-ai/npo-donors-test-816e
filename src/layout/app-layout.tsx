...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['fund-aggregator-employee', 'donor-company-profile-creator', 'donorship-application-viewer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    {
      name: 'Donorship Applications',
      path: '/donorship-applications',
