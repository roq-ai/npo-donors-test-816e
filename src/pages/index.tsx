...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`npo-donors-test`}</title>

        <meta
          name="description"
          content="npo-donors-test: Empowering fund aggregators and non-profit organizations with streamlined donor management, efficient application processes, and enhanced communication capabilities."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmdW5kcmFpc2luZ3xlbnwwfHx8fDE2OTgzMDE0MTB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@kattyukawa?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Katt Yukawa`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`npo-donors-test: Empowering fund aggregators and non-profit organizations with streamlined donor management, efficient application processes, and enhanced communication capabilities.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card
                  userTypeName="Fund Aggregator Employee"
                  type="fund-aggregator-employee"
